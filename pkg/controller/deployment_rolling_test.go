		...
		DescribeTable("##table",
			...
			Entry("remove autoscaler annotation when by-mcm annotation is present", &data{
				setup: setup{
					...
					existingAnnotations: map[string]string{
						"anno1": "anno1",
						v1alpha1.ClusterAutoscalerScaleDownDisabledAnnotationByMCMKey: v1alpha1.ClusterAutoscalerScaleDownDisabledAnnotationByMCMValue,
						v1alpha1.ClusterAutoscalerScaleDownDisabledAnnotationKey:      v1alpha1.ClusterAutoscalerScaleDownDisabledAnnotationValue,
					},
				},
				action: action{
					machineSets: newMachineSets(
